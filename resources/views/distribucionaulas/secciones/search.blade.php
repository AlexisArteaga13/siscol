{!! Form::open(array('url'=> 'distribucionaulas/secciones','method'=>'GET','autocomplete'=>'on', 'role'=>'search')) !!}
<div class="form-group">
<div class="form-group">
        <label>Buscar Por:</label>
        <select name="tipodebuscar" class="form-control-sidebar-bg-black-active">
        @if($tipodebuscar == "s.cod_sección")
            <option value= "s.cod_sección" selected>Código de Sección</option>
            <option value="s.nombre_seccion">Nombre de Sección</option>
        ...
        @else
        @if($tipodebuscar == "s.nombre_seccion")
        <option value= "s.cod_sección" >Código de Sección</option>
            <option value="s.nombre_seccion"selected>Nombre de Sección</option>
            <option value= "g.cod_grado" >Código de Grado</option>
            <option value="g.nombre_grado">Nombre de Grado</option>
            <option value="g.cod_nivel">Codigo de nivel</option>
            <option value="n.nombre_nivel">Nombre de nivel</option>
